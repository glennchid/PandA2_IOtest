...
##(for ST1 test, swap the pin constraint of PANEL_F_OE and PANEL_F_SPARE_0 to read the value of BTN1 on ST1)
#set_property -dict {PACKAGE_PIN D15   IOSTANDARD LVCMOS33  } [get_ports {PANEL_F_SPARE_0}]
set_property -dict {PACKAGE_PIN K14   IOSTANDARD LVCMOS33  } [get_ports {PANEL_F_SPARE_0}]
...
set_property -dict {PACKAGE_PIN D15   IOSTANDARD LVCMOS33  } [get_ports {PANEL_F_OE}]
...
set_property -dict {PACKAGE_PIN AG9   IOSTANDARD LVCMOS18  } [get_ports {PT49}]
...
set_property -dict {PACKAGE_PIN W7    IOSTANDARD LVDS  } [get_ports {FMC_CLK0_M2C_P}]
set_property -dict {PACKAGE_PIN W6    IOSTANDARD LVDS  } [get_ports {FMC_CLK0_M2C_N}]
...
#set_property -dict {PACKAGE_PIN T1    IOSTANDARD LVCMOS18  } [get_ports {LA_P_9}]
#set_property -dict {PACKAGE_PIN U1    IOSTANDARD LVCMOS18  } [get_ports {LA_N_9}]
...
set_property PACKAGE_PIN G8    [get_ports {MGT_WR_IN0_P}]
set_property PACKAGE_PIN G7    [get_ports {MGT_WR_IN0_N}]
...
#set_property -dict {PACKAGE_PIN AD1   IOSTANDARD LVCMOS18  } [get_ports {LA_N_30}]
...
set_property -dict {PACKAGE_PIN AC6   IOSTANDARD LVDS  } [get_ports {FMC_CLK1_M2C_P}]
set_property -dict {PACKAGE_PIN AD6   IOSTANDARD LVDS  } [get_ports {FMC_CLK1_M2C_N}]
...
set_property PACKAGE_PIN J8    [get_ports {MGT_REFCLK1_IN1_P}]
set_property PACKAGE_PIN J7    [get_ports {MGT_REFCLK1_IN1_N}]
set_property PACKAGE_PIN N8    [get_ports {MGT_REFCLK1_IN2_P}]
set_property PACKAGE_PIN N7    [get_ports {MGT_REFCLK1_IN2_N}]
# set_property PACKAGE_PIN J4    [get_ports {FMC_DP_C2M_P0}] # GTH
# set_property PACKAGE_PIN J3    [get_ports {FMC_DP_C2M_N0}] # GTH
...
set_property PACKAGE_PIN F25   [get_ports {MGT_REFCLK0_IN1_P}]
set_property PACKAGE_PIN F26   [get_ports {MGT_REFCLK0_IN1_N}]
...
set_property -dict {PACKAGE_PIN AG10  IOSTANDARD LVCMOS18  } [get_ports {PT50}]
set_property -dict {PACKAGE_PIN AF8   IOSTANDARD LVCMOS18  } [get_ports {PT51}]
set_property -dict {PACKAGE_PIN AF7   IOSTANDARD LVCMOS18  } [get_ports {PT52}]
...
set_property -dict {PACKAGE_PIN AK13  IOSTANDARD LVDS  } [get_ports {PANEL_F_DI_P_0}]
set_property -dict {PACKAGE_PIN AK12  IOSTANDARD LVDS  } [get_ports {PANEL_F_DI_N_0}]
set_property -dict {PACKAGE_PIN AH7   IOSTANDARD LVDS  } [get_ports {PANEL_F_DI_P_1}]
set_property -dict {PACKAGE_PIN AJ7   IOSTANDARD LVDS  } [get_ports {PANEL_F_DI_N_1}]
set_property -dict {PACKAGE_PIN AG13  IOSTANDARD LVDS  } [get_ports {PANEL_F_DO_P_0}]
set_property -dict {PACKAGE_PIN AH13  IOSTANDARD LVDS  } [get_ports {PANEL_F_DO_N_0}]
set_property -dict {PACKAGE_PIN AF11  IOSTANDARD LVDS  } [get_ports {PANEL_F_DO_P_1}]
set_property -dict {PACKAGE_PIN AG11  IOSTANDARD LVDS  } [get_ports {PANEL_F_DO_N_1}]

set_property PACKAGE_PIN L8    [get_ports {MGT_REFCLK0_IN2_P}]
set_property PACKAGE_PIN L7    [get_ports {MGT_REFCLK0_IN2_N}]
set_property PACKAGE_PIN R8    [get_ports {MGT_REFCLK0_IN3_P}]
set_property PACKAGE_PIN R7    [get_ports {MGT_REFCLK0_IN3_N}]
# set_property PACKAGE_PIN K2    [get_ports {FMC_DP_M2C_P0}] # GTH
# set_property PACKAGE_PIN K1    [get_ports {FMC_DP_M2C_N0}] # GTH
...
set_property PACKAGE_PIN D25   [get_ports {MGT_REFCLK1_IN3_P}]
set_property PACKAGE_PIN D26   [get_ports {MGT_REFCLK1_IN3_N}]
...
set_property -dict {PACKAGE_PIN AE13  IOSTANDARD LVDS  } [get_ports {FMC_CLK2_BIDIR_P}]
set_property -dict {PACKAGE_PIN AF13  IOSTANDARD LVDS  } [get_ports {FMC_CLK2_BIDIR_N}]
set_property -dict {PACKAGE_PIN AB13  IOSTANDARD LVDS  } [get_ports {FMC_CLK3_BIDIR_P}]
set_property -dict {PACKAGE_PIN AC13  IOSTANDARD LVDS  } [get_ports {FMC_CLK3_BIDIR_N}]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ext_clk_inst/IBUFDS_inst/O]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets fmc_clk2_inst/IBUFDS_inst/O]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets fmc_clk3_inst/IBUFDS_inst/O]
